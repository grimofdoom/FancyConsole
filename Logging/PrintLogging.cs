using static FancyConsole.Text.Print;

namespace FancyConsole.Logging {
    public static class Log {
        ...
        /// <summary>What folder to place logs into, when printed</summary>
        ...
        public static void LogsToFile() {
            //If there are no warnings or errors, then don't bother trying
            if (WarningLog.Count == 0 && ErrorLog.Count == 0) return;
            ...
            //Folder for logs to be held, generate if not existing already
